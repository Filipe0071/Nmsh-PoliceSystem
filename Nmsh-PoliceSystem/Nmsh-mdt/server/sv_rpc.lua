...
RegisterNetEvent('un-remoteCalls:cl_request')
AddEventHandler('un-remoteCalls:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('un-remoteCalls:cl_response', src, origin, callId, response)
end)
