...
LoadQBCoreVersion = function()
    RPC.register("Nmsh-mdt:isAdmin", function()
    ...
    RPC.register("Nmsh-mdt:getInfo", function()
        ...
        for index, job in pairs(Config["PoliceJobs"]) do
            for index2, job2 in pairs(Config["EMSJobs"]) do
                if xPlayer.PlayerData.job.name == job or xPlayer.PlayerData.job.name == job2 then
                    ...
                    TriggerClientEvent("Nmsh-mdt:open", source, job, jobLabel, lastname, firstname)
                end
            end
        end
    end)
    RPC.register("Nmsh-mdt:dashboardbulletin", function()
        return GetAllBulletinData()
    end)
    RPC.register("Nmsh-mdt:dashboardMessages", function()
        return GetAllMessages()
    end)
    RPC.register("Nmsh-mdt:getWarrants", function()
        local WarrantData = {}
    ...
    RPC.register("Nmsh-mdt:getActiveLSPD", function()
        local ActiveLSPD = {}
        for index, player in pairs(QBCore.Functions.GetPlayers()) do
            ...
            if xPlayer.PlayerData.job.name == "police" then
                table.insert(ActiveLSPD, {
                    ...
                    callsign = GetResourceKvpString("Nmsh-mdt:callsign-"..xPlayer.PlayerData.citizenid),
    ...
    RPC.register("Nmsh-mdt:getActiveEMS", function()
        local ActiveEMS = {}
        for index, player in pairs(QBCore.Functions.GetPlayers()) do
            local xPlayer = QBCore.Functions.GetPlayer(player)
    ...
    RPC.register("Nmsh-mdt:getProfileData", function(citizenid)
        local ReturnData = {}
        local result = SQL('SELECT * FROM '..Config["CoreSettings"]["QBCore"]["Players_Table"]..' WHERE citizenid = @citizenid', {['@citizenid'] = citizenid})
        local CharInfo = json.decode(result[1].charinfo)
    ...
    RPC.register("Nmsh-mdt:JailPlayer", function(cid, time)
        JailPlayer(source, cid, time)
    end)
    RPC.register("Nmsh-mdt:saveProfile", function(profilepic, information, cid)
    ...
    RPC.register("Nmsh-mdt:addGalleryImg", function(cid, url)
    ...
    RPC.register("Nmsh-mdt:removeGalleryImg", function(cid, url)
        SQL("SELECT * FROM "..Config["CoreSettings"]["QBCore"]["Players_Table"].." WHERE citizenid = @citizenid", {
            ['@citizenid'] = cid
        }, function(result)
            local NewGallery = {}
    ...
    RPC.register("Nmsh-mdt:addWeapon", function(cid, serialnumber)
    ...
    RPC.register("Nmsh-mdt:newTag", function(identifier, tag)
        SQL("SELECT * FROM "..Config["CoreSettings"]["QBCore"]["Players_Table"].." WHERE citizenid = @citizenid", {
    ...
    RPC.register("Nmsh-mdt:missingCitizen", function(cid, time)
    ...
    RPC.register("Nmsh-mdt:removeProfileTag", function(cid, tagtext)
        SQL("SELECT * FROM "..Config["CoreSettings"]["QBCore"]["Players_Table"].." WHERE citizenid = @citizenid", {
            ['@citizenid'] = cid
        }, function(result)
            local NewTags = {}
    ...
    RPC.register("Nmsh-mdt:updateLicence", function(type, status, cid)
        ManageLicenses(cid, type, status)
    end)
    RPC.register("Nmsh-mdt:deleteBulletin", function(id, time)
        local src = source
        local xPlayer = QBCore.Functions.GetPlayer(src)
    ...
    RPC.register("Nmsh-mdt:newBulletin", function(title, info, time)
        local src = source
        local xPlayer = QBCore.Functions.GetPlayer(src)
    ...
    RPC.register("Nmsh-mdt:searchProfile", function(name)
        local Matches = {}
    ...
    RPC.register("Nmsh-mdt:searchIncidents", function(incident)
        local Matches = {}
    ...
    RPC.register("Nmsh-mdt:saveIncident", function(ID, title, information, tags, officers, civilians, evidence, associated, time)
        local src = source
        local xPlayer = QBCore.Functions.GetPlayer(src)
    ...
    RPC.register("Nmsh-mdt:getAllIncidents", function()
        local Tables = {}
    ...
    RPC.register("Nmsh-mdt:getIncidentData", function(id)
        local result = SQL('SELECT * FROM mdt_incidents WHERE id = @id', {['@id'] = id})
        local convictions = {}
    ...
    RPC.register("Nmsh-mdt:incidentSearchPerson", function(name)
        local Matches = {}
        local users = SQL("SELECT * FROM "..Config["CoreSettings"]["QBCore"]["Players_Table"].."", {})
        for index = 1, #users, 1 do
            local CharInfo = json.decode(users[index].charinfo)
    ...
    RPC.register("Nmsh-mdt:removeIncidentCriminal", function(cid, incidentId)
    ...
    RPC.register("Nmsh-mdt:getPenalCode", function()
        local xPlayer = QBCore.Functions.GetPlayer(source)
        for index, job in pairs(Config["PoliceJobs"]) do
            for index2, job2 in pairs(Config["EMSJobs"]) do
                if xPlayer.PlayerData.job.name == job then
    ...
    RPC.register("Nmsh-mdt:searchBolos", function(searchVal)
        local Matches = {}
        local BolosData = SQL("SELECT * FROM mdt_bolos", {})
        for index = 1, #BolosData, 1 do
    ...
    RPC.register("Nmsh-mdt:getAllBolos", function()
        local Tables = {}
        local BolosData = SQL("SELECT * FROM mdt_bolos", {})
        for index = 1, #BolosData, 1 do
    ...
    RPC.register("Nmsh-mdt:getAllMissing", function()
        local Tables = {}
    ...
    RPC.register("Nmsh-mdt:getBoloData", function(id)
        local result = SQL('SELECT * FROM mdt_bolos WHERE id = @id', {['@id'] = id})
        return result[1]
    end)
    RPC.register("Nmsh-mdt:newBolo", function(existing, id, title, plate, owner, individual, detail, tags, gallery, officers, time)
        local src = source
        local xPlayer = QBCore.Functions.GetPlayer(src)
    ...
    RPC.register("Nmsh-mdt:deleteBolo", function(id, time)
        local xPlayer = QBCore.Functions.GetPlayer(source)
    ...
    RPC.register("Nmsh-mdt:deleteIncident", function(id, time)
        local xPlayer = QBCore.Functions.GetPlayer(source)
    ...
    RPC.register("Nmsh-mdt:deleteMissing", function(id, time)
        local xPlayer = QBCore.Functions.GetPlayer(source)
    ...
    RPC.register("Nmsh-mdt:deleteReport", function(id, time)
        local xPlayer = QBCore.Functions.GetPlayer(source)
    ...
    RPC.register("Nmsh-mdt:deleteICU", function(id)
        SQL("DELETE FROM mdt_bolos WHERE id = @id", {['@id'] = id})
    end)
    RPC.register("Nmsh-mdt:getAllReports", function()
        local Tables = {}
    ...
    RPC.register("Nmsh-mdt:getReportData", function(id)
        local result = SQL('SELECT * FROM mdt_report WHERE id = @id', {['@id'] = id})
        return result[1]
    end)
    RPC.register("Nmsh-mdt:searchReports", function(name)
        local Matches = {}
    ...
    RPC.register("Nmsh-mdt:newReport", function(existing, id, title, reporttype, detail, tags, gallery, officers, civilians, time)
        local src = source
        local xPlayer = QBCore.Functions.GetPlayer(src)
        if not existing then
    ...
    RPC.register("Nmsh-mdt:searchVehicles", function(name)
        local ReturnData = {}
    ...
    RPC.register("Nmsh-mdt:searchWeapon", function(name)
        local ReturnData = {}
    ...
    RPC.register("Nmsh-mdt:saveMissingInfo", function(id, imageurl, notes)
    ...
    RPC.register("Nmsh-mdt:searchMissing", function(name)
        local ReturnData = {}
    ...
    RPC.register("Nmsh-mdt:getWeaponData", function(serialnumber)
        local result = SQL('SELECT * FROM mdt_weapons WHERE serialnumber = @serialnumber', {['@serialnumber'] = serialnumber})
        if result[1] then
            return result[1]
        end
    end)
    RPC.register("Nmsh-mdt:getMissingData", function(id)
    ...
    RPC.register("Nmsh-mdt:saveWeaponInfo", function(serialnumber, imageurl, brand, type, notes)
    ...
    RPC.register("Nmsh-mdt:getVehicleData", function(plate)
    ...
    RPC.register("Nmsh-mdt:saveVehicleInfo", function(plate, imageurl, notes)
        local result = SQL('SELECT * FROM mdt_vehicleinfo WHERE plate = @plate', {['@plate'] = plate})
        if result[1] then
    ...
    RPC.register("Nmsh-mdt:knownInformation", function(type, status, plate)
        local result = SQL('SELECT * FROM mdt_vehicleinfo WHERE plate = @plate', {['@plate'] = plate})
        if result[1] then
            if type == "code5" then
    ...
    RPC.register("Nmsh-mdt:getAllLogs", function()
        local result = SQL('SELECT * FROM mdt_logs LIMIT 120', {})
        return result
    end)
    RPC.register("Nmsh-mdt:toggleDuty", function(cid, status)
        ChangePlayerDuty(cid, status)
    end)
    RPC.register("Nmsh-mdt:setCallsign", function(cid, newcallsign)
        SetResourceKvp("Nmsh-mdt:callsign-"..cid, tostring(newcallsign))
        return GetResourceKvpString("Nmsh-mdt:callsign-"..cid)
    end)
    RPC.register("Nmsh-mdt:setWaypoint", function(callid)
    ...
    RPC.register("Nmsh-mdt:callDetach", function(callid)
        local src = source
        local NewTable = {}
    ...
    RPC.register("Nmsh-mdt:removeCall", function(callid)
        MDTDispatchData[callid] = nil
        return source, callid
    end)
    RPC.register("Nmsh-mdt:callAttach", function(callid)
        local src = source
    ...
    RPC.register("Nmsh-mdt:attachedUnits", function(callid)
        local ReturnData = {}
        for index, data in pairs(AttachedUnits) do
            if data.CallId == callid then
                ...
                table.insert(ReturnData, {
                    ...
                    callsign = GetResourceKvpString("Nmsh-mdt:callsign-"..xPlayer.PlayerData.citizenid) or "No Callsign",
    ...
    RPC.register("Nmsh-mdt:callDispatchDetach", function(callid, cid)
    ...
    RPC.register("Nmsh-mdt:setDispatchWaypoint", function(callid)
        return MDTDispatchData[callid]
    end)
    RPC.register("Nmsh-mdt:callDragAttach", function(callid, cid)
        local xPlayer = QBCore.Functions.GetPlayerByCitizenId(tostring(cid))
        for _, data in pairs(AttachedUnits) do
            if data.CallId == callid then
    ...
    RPC.register("Nmsh-mdt:sendMessage", function(message, time)
        local src = source
        local xPlayer = QBCore.Functions.GetPlayer(src)
        local ReturnData = {}
    ...
    RPC.register("Nmsh-mdt:refreshDispatchMsgs", function()
        return GetAllMessages()
    end)
    RPC.register("Nmsh-mdt:setWaypoint:unit", function(cid)
        local xPlayer = QBCore.Functions.GetPlayerByCitizenId(cid)
        local xPlayerCoords = GetEntityCoords(GetPlayerPed(xPlayer.PlayerData.source))
        return xPlayerCoords
    end)
    RPC.register("Nmsh-mdt:isLimited", function()
        local xPlayer = QBCore.Functions.GetPlayer(source)
...
LoadESXVersion = function()
        ...
        for index, player in pairs(ESX.GetPlayers()) do
            ...
            if xPlayer.job.name == "police" then
                table.insert(ActiveLSPD, {
                    ...
                    callsign = GetResourceKvpString("Nmsh-mdt:callsign-"..xPlayer.identifier),
    ...
    RPC.register("Nmsh-mdt:getProfileData", function(identifier)
        local ReturnData = {}
        local result = SQL('SELECT * FROM users WHERE identifier = @identifier', {['@identifier'] = identifier})
    ...
    RPC.register("Nmsh-mdt:deleteBulletin", function(id)
        local src = source
        local xPlayer = ESX.GetPlayerFromId(src)
        SQL("DELETE FROM mdt_bulletins WHERE id = @id", {['@id'] = id}, function(isSec)
        ...
        for index, data in pairs(AttachedUnits) do
            if data.CallId == callid then
                ...
                table.insert(ReturnData, {
                    ...
                    callsign = GetResourceKvpString("Nmsh-mdt:callsign-"..xPlayer.identifier) or "No Callsign",
            ...
            for index, job in pairs(Config["PoliceJobs"]) do
                if xPlayer.job == job then
                    table.insert(ActiveLSPD, {
                        ...
                        callsign = GetResourceKvpString("Nmsh-mdt:callsign-"..xChar.id),
                        radio = GetPlayerRadio(xPlayer.source)
                    })
                end
            end
        ...
        for index, data in pairs(AttachedUnits) do
            if data.CallId == callid then
                ...
                table.insert(ReturnData, {
                    cid = xChar.id,
                    job = xPlayer.job,
                    callsign = GetResourceKvpString("Nmsh-mdt:callsign-"..xChar.id) or "No Callsign",
