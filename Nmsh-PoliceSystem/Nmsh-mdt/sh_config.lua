...
Config["PoliceRosterLink"] = "https://discord.com/api/webhooks/943475931224363028/inldiuNn94V54F9GqUuzaTueFI4FXf5X5i7_FStOLClcz3msy9IBg4C3WG4F5MCYPgxK"

Config["EMSRosterLink"] = "https://discord.com/api/webhooks/943475931224363028/inldiuNn94V54F9GqUuzaTueFI4FXf5X5i7_FStOLClcz3msy9IBg4C3WG4F5MCYPgxK"
...
Config["StaffLogs"] = {
    ["NewBulletin"] = "%s أنشأ نشرة جديدة.",
    ["DeleteBulletin"] = "%s قام بحذف نشرة.",
    ["NewIncident"] = "%s قام بإنشاء قضية جديدة",
    ["EditIncident"] = "%s قام بالتعديل على قضية",
    ["DeleteIncident"] = "%s قام بحذف قضية.",
    ["NewReport"] = "%s قا بإنشاء تقرير جديد.",
    ["EditReport"] = "%s قام بالتعديل على التقرير.",
    ["DeleteReport"] = "%s قام بحذف تقرير.",
    ["NewBolo"] = "%s قا بإنشاء بولو جديد.",
    ["EditBolo"] = "%s قام بالتعديل على بولو.",
    ["DeleteBolo"] = "%s قام بحذف بولو.",
    ["DeleteMissing"] = "%s قام بحذف المواطن المفقود من القائمة."
}
